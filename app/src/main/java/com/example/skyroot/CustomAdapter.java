...
public class CustomAdapter implements ListAdapter {
    ...
    Context context;
    public CustomAdapter(Context context, ArrayList<Answer> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Answer answerData=arrayList.get(position);
        if(convertView==null) {
            ...
            answerCurrent.setText(answerData.getAnswer());
            resultCurrent.setText(answerData.getResult());
        }
        return convertView;
    }
    @Override
